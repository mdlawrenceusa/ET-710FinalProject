...
DROP TABLE IF EXISTS `Ref_Order_Item_Status`;
...
--
-- Dumping data for table `Ref_Order_Item_Status`
--

LOCK TABLES `Ref_Order_Item_Status` WRITE;
/*!40000 ALTER TABLE `Ref_Order_Item_Status` DISABLE KEYS */;
INSERT INTO `Ref_Order_Item_Status` VALUES ('CL','Canceled'),('DL','Delivered'),('PD','Paid');
/*!40000 ALTER TABLE `Ref_Order_Item_Status` ENABLE KEYS */;
UNLOCK TABLES;
